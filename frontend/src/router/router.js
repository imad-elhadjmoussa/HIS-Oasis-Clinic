...
import FacturationHomePage from "../components/Facturation/FacturationHomePage.vue";
import FacturationPatient from "../components/Facturation/FacurationPatient.vue";
import PatientF from "../components/Facturation/facturePatient.vue";
import Borderau from "../components/Facturation/Borderau.vue";
...
const adminRoutes = [
  { path: "/", component: AdminHomePage },
  {
    ...
    children: [{ path: "", name: "Users", component: UserPage }],
  },
  {
    path: "/reception",
  ...
  },
  {
    ...
    children: [
      { path: "", component: CashierPage },
      {
        ...
        component: CashierPrestationsList,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        component: FacturationHomePage,
      },
      {
        path: "/patient/:id",
        name: "xxx",
        component: FacturationPatient,
        props: true,
      },
      { path: "/patientF", component: PatientF, props: true },
      { path: "/borderau", name: "Borderau", component: Borderau, props: true },
    ],
  },
  {
    path: "/:pathMatch(.*)*", // This will match any route that hasn't been matched before
    component: NotFoundPage, // Your 404 component
  },
];
...
//     props: true,
//   },
//   // { path: '/homep', component: homep },
//   // { path: '/proformat', component: proformat },
//   // { path: '/viewfacture', component: viewfacture },
//   // { path: '/stepparticulier', component: StepParticulier },
//   // { path: '/proformatp', component: Proformatp },
//   // { path: '/AddPatientModel', component: addpatient },
//   { path: "/patientF", component: PatientF, props: true },
//   { path: "/borderau", name: "Borderau", component: Borderau, props: true },
// ];
...
router.beforeEach(async (to, from, next) => {
  ...
  if (userStore.isAuthenticated) {
    ...
    if (!routesAdded) {
      ...
      } else if (userStore.role === "Facturation") {
        facurationRoutes.forEach((route) => router.addRoute(route)); // Add facuration routes dynamically
      }
      routesAdded = true;
